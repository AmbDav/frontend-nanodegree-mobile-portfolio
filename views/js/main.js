...
//Change in the way the math is written. Some site indicate that scrollTop can create issues.

function updatePositions() {
  var scrolling = lastKnownY / 1250;
